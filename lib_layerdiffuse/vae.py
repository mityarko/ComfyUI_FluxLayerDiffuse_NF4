...
class UNet1024(ModelMixin, ConfigMixin):
    ...
    def __init__(
            ...
            "AttnUpBlock2D", "AttnUpBlock2D", "AttnUpBlock2D", "UpBlock2D", "UpBlock2D", "UpBlock2D", "UpBlock2D"),
...
class TransparentVAE(torch.nn.Module):
    def __init__(self, sd_vae, dtype=torch.float16, encoder_file=None, decoder_file=None, alpha=300.0, latent_c=16,
                 *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.dtype = dtype
